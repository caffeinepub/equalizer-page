...
const EQ_BANDS = [
  ...
  { freq: 3e3, label: "3kHz" },
  { freq: 6e3, label: "6kHz" },
  { freq: 12e3, label: "12kHz" },
  { freq: 14e3, label: "14kHz" },
  { freq: 16e3, label: "16kHz" }
];
const EQ_PRESETS = {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              boxShadow: "inset -8px 0 24px rgba(0,0,0,0.5), 0 0 40px rgba(255,215,0,0.1)",
              position: "relative"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: 32 }, children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: "80,000W · 4 SOUND ENGINES · BLOCKCHAIN VERIFIED"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
...
function BatteryDisplay({ charge, label }) {
  const mah = Math.round(charge / 100 * 8e5);
  const isFull = charge >= 100;
  const fillColor = charge < 30 ? "linear-gradient(to top, #0a1f4a, #1a3a7a)" : charge < 70 ? "linear-gradient(to top, #0a1f4a, #2255aa, #886600)" : "linear-gradient(to top, #0a2260, #1a4499, #cc8800, #FFD700)";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-label", style: { marginBottom: 4 }, children: label }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              borderRadius: 6,
              overflow: "hidden",
              boxShadow: isFull ? "0 0 30px rgba(255,215,0,0.6), 0 0 60px rgba(255,215,0,0.3)" : "0 0 10px rgba(255,215,0,0.1)"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
              ...
              [25, 50, 75].map((pct) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    position: "absolute",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: {
        ...
        cursor: "ns-resize",
        position: "relative",
        boxShadow: "0 0 10px rgba(255,215,0,0.2), inset 0 0 8px rgba(0,0,0,0.5)",
        userSelect: "none"
      },
...
function App() {
  ...
  const [charge1, setCharge1] = reactExports.useState(0);
  const [charge2, setCharge2] = reactExports.useState(0);
  const [charging, setCharging] = reactExports.useState(false);
  const chargeIntervalRef = reactExports.useRef(null);
  ...
  const logBlockchain = reactExports.useCallback((action, value) => {
  ...
  const startCharging = reactExports.useCallback(() => {
    if (charging || batteriesFullyCharged) return;
    setCharging(true);
    logBlockchain("CHARGE_START", "0%");
    chargeIntervalRef.current = setInterval(() => {
      setCharge1((prev) => {
        const next = Math.min(100, prev + 100 / (6e3 / 60));
        return next;
      });
      setCharge2((prev) => {
        const next = Math.min(100, prev + 100 / (6e3 / 60));
  ...
  const setEqBand = reactExports.useCallback(
    (idx, val) => {
      setEqGains((prev) => {
        const next = [...prev];
        next[idx] = val;
  ...
  const toggleEngine = reactExports.useCallback(
    (idx) => {
      setEngines((prev) => {
        const next = prev.map((e, i) => i === idx ? { ...e, on: !e.on } : e);
        if (engineGainNodesRef.current[idx]) {
          engineGainNodesRef.current[idx].gain.value = next[idx].on ? next[idx].gain / 100 : 0;
        }
        logBlockchain(
          "ENGINE_TOGGLE",
  ...
  const setEngineGain = reactExports.useCallback(
    (idx, val) => {
      setEngines((prev) => {
  ...
  const playTrack = reactExports.useCallback(
    (idx) => {
      if (!batteriesFullyCharged) return;
      const audio = audioRef.current;
      if (!audio || !tracks[idx]) return;
      const ctx = initAudio();
      if ((ctx == null ? void 0 : ctx.state) === "suspended") ctx.resume();
  ...
  const togglePlay = reactExports.useCallback(() => {
    ...
    if (audio.paused) {
      ...
      logBlockchain("PLAY", ((_a3 = tracks[currentTrackIdx]) == null ? void 0 : _a3.name) ?? "");
    } else {
      audio.pause();
      setIsPlaying(false);
      logBlockchain("PAUSE", "");
  ...
  const nextTrack = reactExports.useCallback(() => {
    if (!tracks.length) return;
    const idx = shuffle ? Math.floor(Math.random() * tracks.length) : (currentTrackIdx + 1) % tracks.length;
    playTrack(idx);
  }, [tracks, currentTrackIdx, shuffle, playTrack]);
  const prevTrack = reactExports.useCallback(() => {
    if (!tracks.length) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
        minHeight: "100vh",
        background: "linear-gradient(180deg, #04080f 0%, #0a1628 30%, #071020 100%)",
        color: "#e8e0cc",
        fontFamily: "JetBrains Mono, monospace",
        paddingBottom: 80
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("audio", { ref: audioRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx("track", { kind: "captions" }) }),
        showIntro && /* @__PURE__ */ jsxRuntimeExports.jsx(BookIntro, { onClose: () => setShowIntro(false) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "header",
          {
            style: {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 16 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 4, alignItems: "center" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.55rem", color: "rgba(255,215,0,0.5)" }, children: "BAT" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            ...
                            bottom: 0,
                            width: `${overallCharge}%`,
                            background: overallCharge < 30 ? "#1a3a7a" : overallCharge < 70 ? "#886600" : "#FFD700",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: "0.55rem", color: "rgba(255,215,0,0.7)" }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      ...
                      background: masterPower ? "rgba(255,215,0,0.15)" : "rgba(10,20,40,0.5)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { style: { maxWidth: 1200, margin: "0 auto", padding: "24px 16px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "section",
            {
              ...
              children: [
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          children: "BATTERY SYSTEM — 1,600,000 mAh TOTAL"
                        }
                      )
                    ]
                  }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 32, alignItems: "flex-end" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(BatteryDisplay, { charge: charge1, label: "BATTERY A" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(BatteryDisplay, { charge: charge2, label: "BATTERY B" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-label", style: { marginBottom: 16 }, children: "BATTERY CHARGER — 200,000W OUTPUT" }),
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                "div",
                                {
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: "0.6rem", color: "#FFD700" }, children: [
                                      Math.round(overallCharge),
                                      "%"
                                    ] })
                                  ]
                                  ...
                                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "div",
                                    {
                                      style: {
                                        height: "100%",
                                        width: `${overallCharge}%`,
                                        background: overallCharge < 50 ? "linear-gradient(90deg, #0a2260, #1a4499)" : "linear-gradient(90deg, #1a4499, #cc8800, #FFD700)",
                                        borderRadius: 4,
                                        transition: "width 0.3s",
                                        boxShadow: overallCharge > 50 ? "0 0 8px rgba(255,215,0,0.5)" : "none"
                                      }
                                    }
                                  )
                                }
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                style: {
                                  fontSize: "0.65rem",
                                  color: batteriesFullyCharged ? "#FFD700" : "rgba(255,215,0,0.5)",
                                  marginBottom: 16,
                                  textShadow: batteriesFullyCharged ? "0 0 8px rgba(255,215,0,0.6)" : "none"
                                },
                                className: charging ? "charging-text" : "",
                                children: batteriesFullyCharged ? "✓ BATTERIES CHARGED — SYSTEM READY" : charging ? "⚡ CHARGING IN PROGRESS..." : "⚠ SYSTEM LOCKED — Charge batteries to begin"
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "button",
                              {
                                ...
                                className: batteriesFullyCharged ? "" : !charging ? "gold-pulse" : "",
                                style: {
                                  width: "100%",
                                  padding: "12px 0",
                                  background: batteriesFullyCharged ? "rgba(255,215,0,0.1)" : charging ? "rgba(255,165,0,0.15)" : "rgba(255,215,0,0.2)",
                                  border: `2px solid ${batteriesFullyCharged ? "rgba(255,215,0,0.2)" : "#FFD700"}`,
                                  borderRadius: 6,
                                  color: batteriesFullyCharged ? "rgba(255,215,0,0.4)" : "#FFD700",
                                  fontFamily: "JetBrains Mono, monospace",
                                  fontSize: "0.7rem",
                                  fontWeight: 700,
                                  letterSpacing: "0.15em",
                                  cursor: charging || batteriesFullyCharged ? "not-allowed" : "pointer",
                                  transition: "all 0.2s",
                                  textShadow: batteriesFullyCharged ? "none" : "0 0 8px rgba(255,215,0,0.6)"
                                },
                                children: batteriesFullyCharged ? "✓ FULLY CHARGED" : charging ? "⚡ CHARGING..." : "⚡ CHARGE BATTERIES"
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "section",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-label", style: { marginBottom: 12 }, children: "FILE LOADER — DROP AUDIO FILES" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    onKeyDown: (e) => {
                      var _a3;
                      if (e.key === "Enter") (_a3 = fileInputRef.current) == null ? void 0 : _a3.click();
                    },
                    style: {
                      ...
                      textAlign: "center",
                      cursor: "pointer",
                      background: isDraggingOver ? "rgba(255,215,0,0.05)" : "transparent",
                      transition: "all 0.2s",
                      boxShadow: isDraggingOver ? "0 0 20px rgba(255,215,0,0.2)" : "none"
                    },
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: "DROP AUDIO FILES HERE or CLICK TO BROWSE"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                ...
                tracks.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 12 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gold-label", style: { marginBottom: 8 }, children: [
                    "TRACK QUEUE — ",
                    tracks.length,
                    " LOADED"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: tracks.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "button",
                        {
                          type: "button",
                          onClick: () => playTrack(i),
                          style: {
                            padding: "6px 12px",
                            background: currentTrackIdx === i ? "rgba(255,215,0,0.12)" : "transparent",
                            border: `1px solid ${currentTrackIdx === i ? "rgba(255,215,0,0.4)" : "rgba(255,215,0,0.08)"}`,
                            borderRadius: 4,
                            color: currentTrackIdx === i ? "#FFD700" : "rgba(255,255,255,0.6)",
                            fontFamily: "JetBrains Mono, monospace",
                            fontSize: "0.65rem",
                            cursor: "pointer",
                            textAlign: "left",
                          ...
                          children: [
                            ...
                            currentTrackIdx === i && isPlaying && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "▶" }),
                            t.name
                          ]
                        },
                        t.id
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "section",
            {
              ...
              style: {
                ...
                marginBottom: 24,
                position: "relative",
                boxShadow: batteriesFullyCharged ? "0 0 30px rgba(255,215,0,0.15), inset 0 1px 0 rgba(255,215,0,0.12)" : "none"
              },
              children: [
                !batteriesFullyCharged && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      position: "absolute",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: "CHARGE BATTERIES TO UNLOCK"
                        }
                      )
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-label", style: { marginBottom: 16 }, children: "PLAYER CONTROLS" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: 12 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                      ...
                      children: ((_a2 = tracks[currentTrackIdx]) == null ? void 0 : _a2.name) ?? "NO TRACK LOADED"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          style: {
                            ...
                            height: 56,
                            borderRadius: "50%",
                            background: isPlaying ? "radial-gradient(circle, #FFD700, #cc8800)" : "radial-gradient(circle, rgba(255,215,0,0.3), rgba(200,150,0,0.2))",
                            border: `2px solid ${isPlaying ? "#FFD700" : "rgba(255,215,0,0.4)"}`,
                            color: isPlaying ? "#0a1628" : "#FFD700",
                            cursor: batteriesFullyCharged && tracks.length ? "pointer" : "not-allowed",
                            fontSize: "1.4rem",
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            boxShadow: isPlaying ? "0 0 24px rgba(255,215,0,0.6), 0 0 48px rgba(255,215,0,0.3)" : "none",
                            transition: "all 0.2s"
                          },
                          children: isPlaying ? "⏸" : "▶"
                        }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "section",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-label", style: { marginBottom: 8 }, children: "FREQUENCY ANALYZER — REAL-TIME SPECTRUM" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "canvas",
                  {
                    ref: canvasRef,
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          children: "10-BAND GRAPHIC EQUALIZER — REAL AUDIO PROCESSING"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 4, flexWrap: "wrap" }, children: Object.keys(EQ_PRESETS).map((name) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                          ...
                          style: {
                            padding: "3px 8px",
                            background: eqPreset === name ? "rgba(255,215,0,0.2)" : "transparent",
                            border: `1px solid ${eqPreset === name ? "rgba(255,215,0,0.6)" : "rgba(255,215,0,0.15)"}`,
                            borderRadius: 3,
                            color: eqPreset === name ? "#FFD700" : "rgba(255,215,0,0.4)",
                            fontFamily: "JetBrains Mono, monospace",
                            fontSize: "0.55rem",
                            cursor: "pointer",
                            letterSpacing: "0.1em",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, alignItems: "flex-end" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: ["+12", "+6", "0", "-6", "-12"].map((db) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            fontSize: "0.5rem",
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "div",
                                {
                                  style: {
                                    fontSize: "0.5rem",
                                    color: isBoost ? "#FFD700" : isCut ? "#4488ff" : "rgba(255,255,255,0.3)",
                                    fontWeight: 700,
                                    textShadow: isBoost ? "0 0 6px rgba(255,215,0,0.8)" : isCut ? "0 0 6px rgba(68,136,255,0.8)" : "none"
                                  },
                                  children: g > 0 ? `+${g}` : g
                                }
                              ),
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                      "div",
                                      {
                                        ...
                                        children: [
                                          ...
                                          g !== 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                                            "div",
                                            {
                                              style: {
                                                position: "absolute",
                                                width: "100%",
                                                background: isBoost ? "linear-gradient(to top, rgba(255,215,0,0.4), rgba(255,215,0,0.8))" : "linear-gradient(to bottom, rgba(68,136,255,0.4), rgba(68,136,255,0.8))",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { style: { marginBottom: 24 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-label", style: { marginBottom: 12 }, children: "4 SOUND ENGINES — INDEPENDENT CONTROL" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                ...
                children: engines.map((engine, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    style: {
                      ...
                      borderColor: engine.on ? "rgba(255,215,0,0.4)" : "rgba(255,215,0,0.1)",
                      boxShadow: engine.on ? "0 0 16px rgba(255,215,0,0.1)" : "none"
                    },
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "div",
                                    {
                                      style: {
                                        ...
                                        boxShadow: engine.on ? "0 0 8px #00ff88" : "0 0 8px #ff3333",
                                        animation: engine.on && isPlaying ? "led-blink 0.5s ease-in-out infinite" : "none"
                                      }
                                    }
                                  ),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          style: {
                            width: "100%",
                            padding: "8px 0",
                            background: engine.on ? "rgba(255,215,0,0.12)" : "rgba(255,50,50,0.08)",
                          ...
                          children: engine.on ? "⏻ POWERED ON" : "⏻ POWERED OFF"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                          ...
                          children: [
                            ...
                            "div",
                            {
                              ...
                              children: [
                                ...
                                ":",
                                " ",
                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(255,215,0,0.6)" }, children: v })
                              ]
                            },
                            k
                          ))
                  ...
                  ["engine-smart", "engine-freq", "engine-app", "engine-stab"][idx]
                ))
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "section",
            {
              ...
              children: [
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          children: "BLOCKCHAIN STATE LEDGER — SOUND VERIFICATION"
                        }
                      )
                    ]
                  }
                ),
                blockchainLog.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                      fontSize: "0.6rem",
                ...
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { maxHeight: 200, overflowY: "auto" }, children: blockchainLog.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      display: "flex",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(255,215,0,0.5)" }, children: entry.action }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(255,255,255,0.7)" }, children: entry.value }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          style: {
                    ...
                    children: [
                      ...
                      "div",
                      {
                        ...
                        children: [
                          k,
                          ": ",
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(255,215,0,0.7)" }, children: v })
                        ]
                      },
                      k
                    ))
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      " GERROD | ENGINEER | PRODUCT 2 — 80,000W · 4 SOUND ENGINES · BLOCKCHAIN VERIFIED"
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
